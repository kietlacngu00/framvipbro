...
local Fz = {
		...
		["Logo Image"] = "rbxassetid://106113185922406",
...
gz.Image = "rbxassetid://106113185922406";
...
local Uz = function(Y)
		...
		local g = D .. ("," .. (A .. ("," .. u)));
		K.Text = "<font color=\"rgb(" .. (g .. (")\">kietdepzai</font> " .. dz.TitleNameNoti));
		...
		I.Image = "rbxassetid://106113185922406";
...
function Kz.CreateMain(Y)
	...
	r.Image = "rbxassetid://106113185922406";
	...
	local v = i .. ("," .. (U .. ("," .. C)));
	M.Text = "<font color=\"rgb(" .. (v .. ")\">kietdepzai </font> : Blox Fruits");
	...
	F.Position = UDim2.new(0, 5, 0, dz.T1 and 5 or 0);
	F.Size = UDim2.new(0, dz.T1 and 30 or 25, 0, dz.T1 and 15 or 25);
	F.Image = "rbxassetid://106113185922406";
	...
	local S = b .. ("," .. (c .. ("," .. H)));
	M.Text = "<font color=\"rgb(" .. (S .. ")\">kietdepzai </font> : Blox Fruits");
	K.Name = "Background1";
	K.Parent = g;
