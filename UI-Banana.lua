...
spawn(function()
	pcall(function()
		while true do
			...
			local status = isMiragePresent and "âœ…" or "âŒ"
...
spawn(function()
	...
	while task["wait"](1) do
		pcall(function()
			...
			local status = isKitsunePresent and "âœ…" or "âŒ"
...
task["spawn"](function()
	...
	while task["wait"](1) do
		pcall(function()
			...
			local status = isPrehistoricPresent and "âœ…" or "âŒ"
...
spawn(function()
	...
	while wait(1) do
		pcall(function()
			...
			local status = isFrozenPresent and "âœ…" or "âŒ"
...
spawn(function()
	while wait(1) do
		pcall(function()
			...
			local text = string["len"](result) < 86 and "Cake Prince: âœ…" or "Kill: " .. string["sub"](result, 39, 41)
...
spawn(function()
	...
	while wait(1) do
		pcall(function()
			...
			local status = ripIndra and "âœ…" or "âŒ"
...
spawn(function()
	...
	while wait(1) do
		pcall(function()
			...
			local status = doughKing and "âœ…" or "âŒ"
...
spawn(function()
	...
	while wait(1) do
		pcall(function()
			...
			local status = eliteExists and "âœ…" or "âŒ"
...
spawn(function()
	while wait(1) do
		pcall(function()
			local swordStatus = "Legendary Sword: âŒ"
...
spawn(function()
	...
	while wait(1) do
		...
		if success then
			local currentStatus = result and "âœ…" or "âŒ"
